...
public class Employee {
    ...
    private static String NAME_LENGTH_ERR_MSG = "Wrong Name";
    private final int maxVacationDays = 28;
    ...
    public final void setFirstName(String firstName) {
        if (firstName == null || firstName.length() < 2) {
            throw new IllegalArgumentException(NAME_LENGTH_ERR_MSG);
        }
    ...
    public void setSsn(String ssn) {
        ...
        if (ssn.length() == 9) {
            ...
            String ssnNumber = ssnArray[0].concat(ssnArray[1].concat(ssnArray[2]));
            this.ssn = ssnNumber;
